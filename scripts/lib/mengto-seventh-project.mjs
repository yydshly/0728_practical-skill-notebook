...
const registeredSixthProject = [
  "| 06 | [《雾村：逃离》](./rural-mutation-escape/) | `rural-mutation-escape` |",
  "## 06 · 《雾村：逃离》",
...
export function assertStagedRootReadmeBoundary({ stagedFiles, indexReadme }) {
  ...
  for (const required of registeredSixthProject) if (!indexReadme.includes(required)) throw new Error(`staged README is missing registered 06 text: ${required}`);
}
